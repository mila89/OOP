...
namespace Vehicles
{
    class Program
    {
        static void Main()
        {
            ...
            Car currentCar = new Car(double.Parse(inputCar[1]), double.Parse(inputCar[2]));
            Truck currentTruck = new Truck(double.Parse(inputTruck[1]), double.Parse(inputTruck[2]));
